            ...
            {!result.valid ? (
              ...
              <div className="space-y-8">
                {result.exactFailureReason && (
                  <div className="p-4 rounded-control border border-red-500/30 bg-red-500/10 text-red-700 text-xs font-mono flex items-start gap-3 shadow-xs">
                    <AlertCircle className="w-5 h-5 text-red-600 shrink-0 mt-0.5" />
                    <div className="space-y-1">
                      <p className="font-bold text-red-800 text-sm font-sans">API Key Attention Required</p>
                      <p className="text-red-700 font-mono text-xs">{result.exactFailureReason}</p>
                    </div>
                  </div>
                )}
                                ...
                                <td className="py-2.5 px-3">
                                  {req.statusCode < 400 ? (
                                    ...
                                    <div className="flex flex-col" title={req.errorMessage || req.errorCode || 'Failed'}>
                                      <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-red-500/10 text-red-600 border border-red-500/30 inline-flex items-center gap-1 w-fit">
