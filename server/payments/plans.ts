...
export const FREE_TRIAL_PLAN: ServerPlan = {
  ...
  slug: 'trial',
  name: 'Free Trial',
  displayName: '1M Free Trial Key',
  tokenAllowance: 1000000n,
  tokenDisplay: '1M TOKENS',
  windowHours: 24,
  validityDays: 1,
  rateLimitRpm: 30,
  priceInr: 0,
  currency: 'INR',
  tagline: 'Instant free trial key for evaluation',
  badge: 'FREE TRIAL',
  features: ['1,000,000 Tokens / 24h', '24h Validity', 'Claude Sonnet 5 & Haiku 4.5 Access'],
  featured: false,
  enabled: true,
  displayOrder: 0,
};

export const TRIAL_PLAN: ServerPlan = FREE_TRIAL_PLAN;
